"""Base commune pour les adaptateurs de mapping utilisant une API compatible OpenAI."""
...
class OpenAICompatibleMappingProposal(MappingProposalPort):
    """Classe de base pour tout adaptateur de mapping reposant sur une API
    de chat completions compatible OpenAI (Ollama, Groq, Dots Studio, ...).

    Les sous-classes fournissent seulement le modèle, la clé d'API et l'URL
    de base : toute la construction du prompt et le parsing de la réponse
    sont partagés ici.
    """
